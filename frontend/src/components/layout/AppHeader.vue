  ...
  <header class="sticky top-0 z-30">
    <div class="flex h-16 items-center justify-between px-4 md:px-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <!-- Balance Display (cream-pill in light · dark-pill in dark) -->
        <div
          v-if="user"
          class="group relative hidden items-center gap-2 rounded-xl border border-[#ebe6dc] bg-[#faf7f0] px-3 py-1.5 dark:border-transparent dark:bg-[#0f0f10] sm:flex"
          tabindex="0"
          :aria-label="`${balanceAvailableText} ${formatHeaderMoney(availableBalance)}; ${balanceFrozenText} ${formatHeaderMoney(frozenBalance)}; ${balanceTotalText} ${formatHeaderMoney(totalBalance)}`"
        >
          <span class="text-[10px] font-semibold uppercase tracking-widest text-[#a8a29e] dark:text-white/50">
            {{ t('common.balance') }}
          </span>
          <span class="font-mono text-sm font-bold text-[#ff6b35]">
