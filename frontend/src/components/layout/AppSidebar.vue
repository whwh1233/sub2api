...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/group-realtime', label: t('groupRealtime.title'), icon: ChartIcon, featureFlag: flagOpsMonitoring },
    { path: '/admin/users', label: t('nav.users'), icon: UsersIcon, hideInSimpleMode: true },
    { path: '/admin/balances', label: t('nav.balanceOverview'), icon: CreditCardIcon, hideInSimpleMode: true },
