export default {
  promptAudit: {
    ...
    events: {
      ...
      selectAll: '选择当前页全部事件', selectEvent: '选择事件 {id}', time: '时间', identity: '调用方', user: '用户名', email: '用户邮箱', apiKey: 'API Key 名称', group: '分组', route: '入口 / 模型', requestRoute: '请求 / 路由', result: '状态', empty: '没有符合条件的事件。',
      totalCount: '共 {count} 条', recorded: '仅记录', noGuardCall: '未调用 Guard', unknownApiKey: '未命名 Key',
      latestInput: '本轮输入', noInputExcerpt: '无可显示的文本输入', refresh: '刷新', refreshing: '刷新中…',
