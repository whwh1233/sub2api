export default {
  promptAudit: {
    ...
    recordOnlyHint: 'Record-only mode stores the full text of applicable requests without calling a Guard endpoint or blocking or changing traffic.',
    ...
    saveBar: { enabled: 'Enable prompt audit', recordOnly: 'Record requests only', blocking: 'Synchronous blocking', blockingLatestTurnOnly: 'Only latest input and prior output', storePass: 'Store safe events', dirty: 'Unsaved changes', synced: 'Configuration synced' },
    blockingConfirm: {
    ...
    events: {
      ...
      selectAll: 'Select all events on this page', selectEvent: 'Select event {id}', time: 'Time', identity: 'Caller', user: 'Username', email: 'User email', apiKey: 'API Key name', group: 'Group', route: 'Endpoint / model', requestRoute: 'Request / route', result: 'Status', empty: 'No matching events.',
      totalCount: '{count} total', recorded: 'Recorded only', noGuardCall: 'Guard not called', unknownApiKey: 'Unnamed key',
      latestInput: 'Latest input', noInputExcerpt: 'No text input to display', refresh: 'Refresh', refreshing: 'Refreshing…',
    ...
    errors: {
      ...
      prompt_audit_record_only_conflicts_blocking: 'Record-only mode cannot be combined with synchronous blocking.',
    },
  },
}
