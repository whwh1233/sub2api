export default {
    ops: {
      ...
      rpm: {
        ...
        completeThrough: 'Latest complete bucket ends at {time}',
        partial: 'Missing or incomplete collection is shown as gaps, not zero traffic. Recent data may still be catching up.',
