...
.settings-tab-active {
  @apply border-primary-200/80 text-primary-700 shadow-sm dark:border-primary-400/30 dark:text-primary-200;
  background: linear-gradient(135deg, rgba(255, 107, 53, 0.08), rgba(255, 107, 53, 0.03));
  box-shadow:
    0 8px 18px rgba(255, 107, 53, 0.1),
    0 1px 0 rgb(255 255 255 / 0.92) inset;
}

:root.dark .settings-tab-active {
  background: linear-gradient(135deg, rgba(255, 138, 82, 0.12), rgba(255, 138, 82, 0.05));
  box-shadow:
    0 8px 18px rgb(0 0 0 / 0.25),
...
.settings-tab-active::after {
  ...
  content: "";
  background: linear-gradient(90deg, #ff6b35, #ff8a52);
}
