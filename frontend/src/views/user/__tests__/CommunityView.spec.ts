...
describe('CommunityView', () => {
  ...
  it('renders all community QR codes without tab switching', () => {
    ...
    expect(viewSource).toContain('lg:grid-cols-[1.08fr_1.08fr_0.78fr]')
    expect(viewSource).toContain('grid items-stretch gap-5')
    expect(viewSource).toContain('card flex h-full flex-col')
    expect(viewSource).toContain(':class="channel.shellClass"')
    expect(viewSource).toContain(':class="channel.imageClass"')
    expect(viewSource).toContain('h-[clamp(320px,42vw,680px)]')
    expect(viewSource).toContain('max-w-[560px]')
    expect(viewSource).toContain('max-w-[390px]')
    expect(viewSource).not.toContain('grid flex-1 gap-5')
    expect(viewSource).not.toContain('grid items-start gap-5')
    expect(viewSource).not.toContain('min-h-[520px]')
    expect(viewSource).not.toContain('min-h-[380px] flex-1')
