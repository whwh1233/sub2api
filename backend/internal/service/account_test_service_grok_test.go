...
func TestAccountTestService_TestAccountConnection_GrokAPIKeyUsesConfiguredResponsesEndpoint(t *testing.T) {
	gin.SetMode(gin.TestMode)
	...
	require.Equal(t, "https://xai.test/v1/responses", upstream.lastReq.URL.String())
