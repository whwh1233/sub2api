...
// BalanceSummary contains admin-only aggregate metrics for users' available
// balance. Frozen balance is intentionally excluded because it has already
// been deducted from balance while funds are held.
