...
// Priority: DATA_DIR env > /app/data (non-Windows, if writable) > current directory.
func GetDataDir() string {
	return getDataDirForPlatform(runtime.GOOS, "/app/data")
}

func getDataDirForPlatform(goos, dockerDataDir string) string {
