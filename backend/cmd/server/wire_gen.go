...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	groupRealtimeStore := repository.NewGroupRealtimeStore(redisClient, db)
	...
	opsMetricsCollector := service.ProvideOpsMetricsCollector(opsRepository, settingRepository, accountRepository, concurrencyService, db, redisClient, configConfig, groupRealtimeStore)
